...
## Set daterange of interest as a grepl-friendly format (eg "202207|202208")
grepl_dates = "202206|202207|202208|202209"

## Set ggplot theme
theme_set(theme_bw())

start_date = as.POSIXct("2022-06-01", tz = "UTC") # to match default tz
end_date = as.POSIXct("2022-07-01", tz = "UTC")
...
baro_files <- as_tibble(list.files(path = baro_path, pattern = "*MetTable", full.names = T)) %>% 
...
troll_inventory <- read_csv("/Users/regi350/Downloads/aquatroll_inventory copy.csv") %>% 
  clean_names()
