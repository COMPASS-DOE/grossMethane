...
```{r normalization of gross fluxes}
...
Anova(P_moisture)
```
There's some evidence that location influences methane production, and equally good evidence that soil moisture does.
