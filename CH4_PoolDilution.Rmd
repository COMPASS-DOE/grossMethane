...
pk_results %>%
    # We expect multiple matches; `multiple="all"` silences warning about this
    right_join(incdat_out, by = "id", multiple = "all") ->
    incdat_out
```
...
kable(results,
      caption = "<center><strong>Gross Rates at T2</strong></center>",
      escape = FALSE,
      col.names = NULL,
      align = "c",
      format = "html") %>%
