...
# Need standard deviation of isotopes and mass across all measurements 
# for each sample -> sd_obs, and standard deviation of the analytical precision 
# aka instrument stdev for those observations -> sd_inst
incdat %>% 
    group_by(id) %>% 
...
# 'incdat' is our primary dataset; save for subsequent use
write.csv(incdat, "outputs/incdat.csv")
```
