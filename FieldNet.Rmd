...
ggplot(f_dat[f_dat$Location == "g_low",], aes(month(timestamp), SWC, fill = Origin)) +
    geom_boxplot(aes(group = interaction(month(timestamp), Origin))) +
    scale_fill_discrete(name = "Soil Origin",
                      labels = Olabs) +
    labs(x = "Month", y = "Flux CH4",
...
```{r Follow-up on interaction effect}
...
ggplot(f_dat[f_dat$Location == "g_low",],
       aes(month(timestamp), SWC, fill = Origin)) +
     geom_boxplot(aes(group = interaction(month(timestamp), Origin))) +
     scale_fill_discrete(name = "Soil Origin",
                         labels = Olabs) +
     labs(x = "Month", y = "SWC",
